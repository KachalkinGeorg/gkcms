			...
			<tr>
				...
				<td width="100%" valign="top" style="padding: 5px;">
					<table border="0" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td width="40%" style="padding: 5px;"><b>Имя:</b></td>
							<td width="60%" style="padding: 5px;">{{ user.alt_name }}</td>
						</tr>
						<tr>
							<td width="40%" style="padding: 5px;"><b>Пол:</b></td>
							<td width="60%" style="padding: 5px;">{{ user.gender }}</td>
						</tr>
						<tr>
							<td width="40%" style="padding: 5px;"><b><!-- {{ lang.uprofile['status'] }} --> Группа:</b></td>
							<td width="60%" style="padding: 5px;">{{ user.status }}</td>
						</tr>
						<tr>
							<td width="40%" style="padding: 5px;"><b>Статус:</b></td>
							<td width="60%" style="padding: 5px;">{{ user.line }}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="padding: 5px;">{{ user.news }} 
							{% if pluginIsActive('ublog') %}<a href="/plugin/ublog/?uid={{ user.id }}&uname={{ user.name }}">просмотреть статьи</a>{% endif %}</td>
						</tr>
						<tr>

...
<form id="profileForm" method="post" action="{{ form_action }}" enctype="multipart/form-data">
	...
	<div class="post" style="margin-left:30px;margin-right:30px">
		...
		<div class="post-text">
			...
			<table id="maincontent" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td width="30%">{{ lang.uprofile['alt_name'] }}:</td>
					<td width="70%"><input class="input" type="text" name="editaltname" value="{{ user.alt_name }}"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td width="30%">{{ lang.uprofile['gender'] }}:</td>
					<td width="70%">{{ user.gender }}</td>
				</tr><br>
				<tr>

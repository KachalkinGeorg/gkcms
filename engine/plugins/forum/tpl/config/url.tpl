				...
				<table width="100%" border="0" class="content">
					<tr>
						...
						<td class="contentEntry2" valign=top>{% if (home_forum) %}
								<input type="submit" class="btn btn-success" onmousedown="javascript:window.location.href='{{ admin_url }}/admin.php?mod=extra-config&plugin=forum&action=url&id=home&s=0'" value="Выключить" />{% else %}
								<input type="submit" class="btn btn-info" onmousedown="javascript:window.location.href='{{ admin_url }}/admin.php?mod=extra-config&plugin=forum&action=url&id=home&s=1'" value="Включить" />{% endif %}
						</td>
					</tr>
					<tr>

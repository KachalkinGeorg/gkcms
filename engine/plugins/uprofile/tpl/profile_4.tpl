						...
						<td bgcolor="#FFFFFF">
							...
							<table id="maincontent" class="content" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
								...
								<tr>
									...
									<td style="padding: 5px; background-color: #f9fafb;" class="entry">{{ user.news }} {% if pluginIsActive('ublog') %}<a href="/plugin/ublog/?uid={{ user.id }}&uname={{ user.name }}">просмотреть статьи</a>{% endif %}</td>
								</tr>
								<tr>
								...
								<tr>
									<td style="padding: 5px;" class="entry">{{ lang.uprofile.gender }}</td>
									<td style="padding: 5px;" class="entry">
										{{ user.gender }}
									</td>
								</tr>
								<tr>
									<td style="padding: 5px;" class="entry">{{ lang.uprofile.alt_name }}</td>
									<td style="padding: 5px;" class="entry">
										<input type="text" class="alt_name" name="editaltname" value="{{ user.alt_name }}" size="40"/>
									</td>
								</tr>
								<tr>

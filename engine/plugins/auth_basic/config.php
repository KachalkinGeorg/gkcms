...
array_push($cfgX, array('name' => 'group', 'title' => $lang['auth:group'], 'descr' => $lang['auth:group_descr'], 'type' => 'select', 'values' => array('0' => $lang['noa'], '1' => $lang['yesa']), 'value' => pluginGetVariable('auth_basic', 'group')));

...
$permRules = [
    '#admin'    => [
        ...
        'items'       => [
            ...
            'newsletter' => [
                'title'     => 'Управление рассылок сообщений',
                'items'     => [
                    'details'                   => ['title'     => 'Отправка массовых рассылок сообщений пользователям'],
                ],
            ],
            'lastcomments' => [
                'title'     => 'Управление комментариями пользователей',
                'items'     => [
                    'details'                   => ['title'     => 'Комментарии пользователей'],
                ],
            ],
            'replace' => [
                'title'     => 'Поиск и замена',
                'items'     => [
                    'details'                   => ['title'     => 'Быстрая замена текста в БД'],
                ],
            ],
            'rewrite' => [
            ...
            'rules' => [
                'title'     => 'Управление правилами сайта',
                'items'     => [
                    'details'                   => ['title'     => 'Просмотр шаблонов'],
            ...
            'syslog' => [
                'title'     => 'Просмотр системного лога',
                'items'     => [
                    'details'                   => ['title'     => 'Системный лог'],
                ],
            ],
            'loadlog' => [
                'title'     => 'Просмотр аналитики сайта',
                'items'     => [
                    'details'                   => ['title'     => 'Аналитика сайта'],
                ],
            ],
            'profillog' => [
                'title'     => 'Просмотр лога пользователей',
                'items'     => [
                    'details'                   => ['title'     => 'Лог пользователей'],
                ],
            ],		
            'perm' => [
                'title'     => 'Права доступа',

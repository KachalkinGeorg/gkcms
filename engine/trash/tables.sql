...
CREATE TABLE `XPREFIX_news` (
  ...
  `acces` varchar(150) NOT NULL default '',
  ...
  KEY `news_nosearch` (`nosearch`),
  KEY `news_fixed` (`fixed`)
) ENGINE=InnoDB;
...
CREATE TABLE `XPREFIX_rules` (
  ...
  `keywords` text,
  PRIMARY KEY  (`id`),
  KEY `rules_title` (`title`),
  KEY `rules_altname` (`alt_name`)
) ENGINE=InnoDB;

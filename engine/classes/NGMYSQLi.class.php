...
class NGMYSQLi extends NGDB
{
    ...
    function errorReport($type, $query, $e)
    {
		...
		print_msg( 'error', 'MySQL ERROR', 'ERROR MySQLi: <strong>['.$type.']</strong> - <text style="color: red;">'.$errNo.'</text><br /><br /><text style="color: blue;">'.$errMsg.'</text><br /><br /><text>'.$query.'</text><br /><br />'.$e.'', 'javascript:history.go(-1)' );
    }

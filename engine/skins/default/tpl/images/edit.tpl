<form method="post" action="admin.php">
	...
	<div class="panel panel-default mb-5">
		<div class="panel-heading">{l_edit_title}</div>
		<div class="panel-body">
			<div class="form-group row">
				<label class="col-sm-3 col-form-label">{l_original_name}</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" value="{orig_name}" readonly />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" value="{width} x {height} ( {size} )" readonly />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					[have_stamp]
					<input type="text" class="form-control" value="{l_added}" readonly />
					[/have_stamp]
					[no_stamp]
	...
	<div class="panel panel-default mb-5">
		...
		<div class="panel-body">
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" value="{preview_status}" readonly />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" value="{preview_width} x {preview_height} ( {preview_size} )" readonly />
				</div>
			</div>

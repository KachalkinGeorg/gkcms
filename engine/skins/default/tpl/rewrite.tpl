  ...
  <div class="panel-heading">
	...
	<div class="panel-body">
					...
					<tr id="row.editRow">
						...
						<td>
							<div class="btn-group btn-group-sm" role="group">
								<button id="ed.button" type="button" onclick="reSubmitEdit();" class="btn btn-outline-success">{{ lang['add'] }}</button>
								<button id="ed.bcancel" type="button" onclick="reCancelEdit();" class="btn btn-outline-dark">{{ lang['cancel'] }}</button>
							</div>
						</td>
					</tr>
		...
		<div class="card-footer">
			<button type="button" onclick="reServerSubmit();" class="btn btn-outline-success">{{ lang['save'] }}</button>
		</div>
	</div>
</form>

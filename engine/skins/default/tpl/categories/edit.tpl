			...
			<div class="form-row mb-3">
				...
				<div class="col-lg-6">
					<div class="input-group">
						<input placeholder="Введите заголовок..." type="text" name="name" value="{{ name }}" class="form-control" />
						<div class="input-group-append">
						<a class="btn btn-primary" data-toggle="popover" data-placement="top" data-trigger="focus" data-html="true" title="ЗАГОЛОВОК" data-content="Заголовок категории обязателен к заполнению и может содержать не более 200 символов." tabindex="0">

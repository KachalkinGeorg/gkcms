...
<div id="tags" class="btn-toolbar mb-3" role="toolbar">
	...
	<div class="btn-group btn-group-sm mr-2">
		...
		<div class="dropdown-menu" aria-labelledby="tags-height" style="cursor: pointer;">
			<a class="dropdown-item" onclick="insertfortext('size',1,{{ area }})" >очень маленький</a>
			<a class="dropdown-item" onclick="insertfortext('size',2,{{ area }})" >маленький</a>
			<a class="dropdown-item" onclick="insertfortext('size',3,{{ area }})" >средний</a>
			<a class="dropdown-item" onclick="insertfortext('size',4,{{ area }})" >большой</a>
			<a class="dropdown-item" onclick="insertfortext('size',5,{{ area }})" >очень большой</a>
		</div>
	</div>
	...
	<div class="btn-group btn-group-sm mr-2">
		...
		<div class="dropdown-menu" aria-labelledby="tags-block">
			...
			<a href="#" class="dropdown-item" onclick="insertext('[quote]','[/quote]', {{ area }})"><i class="fa fa-quote-left"></i> {{ lang['tags.quote'] }}</a>

...
<div id="tags" class="btn-toolbar mb-3" role="toolbar">
	...
	<div class="btn-group btn-group-sm mr-2">
		<button id="tags-height" type="button" class="btn btn-outline-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			<i class="fa fa-text-height" aria-hidden="true"></i>
		</button>
		<ul class="dropdown-menu" aria-labelledby="tags-height" style="cursor: pointer;">
			<li><a class="dropdown-item" onclick="insertfortext('size',1,{{ area }})" >очень маленький</a></li>
			<li><a class="dropdown-item" onclick="insertfortext('size',2,{{ area }})" >маленький</a></li>
			<li><a class="dropdown-item" onclick="insertfortext('size',3,{{ area }})" >средний</a></li>
			<li><a class="dropdown-item" onclick="insertfortext('size',4,{{ area }})" >большой</a></li>
			<li><a class="dropdown-item" onclick="insertfortext('size',5,{{ area }})" >очень большой</a></li>
		</ul>
	</div>
	...
	<div class="btn-group btn-group-sm mr-2">
		<button type="button" class="btn btn-outline-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-paint-brush" aria-hidden="true"></i></button>
	...
	<div class="btn-group btn-group-sm mr-2">
		...
		<ul class="dropdown-menu" aria-labelledby="tags-block">
			...
			<li><a href="#" class="dropdown-item" onclick="insertext('[hide]','[/hide]', {{ area }})"><i class="fa fa-shield"></i> {{ lang['tags.hide'] }}</a></li>
		</ul>
	</div>
			...
			<div id="tags-link" class="tab-pane active">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"></label>
						<div class="col-sm-9">
							<label><input type="checkbox" id="modal-url-3" /> Открыть в новом окне</label>
						</div>
					</div>
				</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div id="tags-img-url" class="tab-pane active">
				<div class="form-group">
					<label class="col-sm-5">Ссылка на изображение</label>
						<div class="col-sm-9">

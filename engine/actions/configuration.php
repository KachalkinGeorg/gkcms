...
// Description: Менеджер конфигураций
...
function systemConfigSave()
{
    ...
    try {
		...
		msg(['type' => 'error', 'title' => $lang['db'], 'text' => $lang['dbcheck_error']]);
        return false;
    }
...
{
    global $lang, $AUTH_CAPABILITIES, $PHP_SELF, $twig, $multiconfig, $breadcrumb;

...
{
    global $PERM, $pManager, $twig, $userROW, $lang, $catz, $breadcrumb;
...
{
    global $userROW, $lang, $PERM, $confPerm, $confPermUser, $pManager, $twig, $grp, $breadcrumb;

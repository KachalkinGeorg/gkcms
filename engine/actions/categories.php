...
function admCategoryAddForm()
{
	...
	$breadcrumb = breadcrumb('<i class="fa fa-plus btn-position"></i><span class="text-semibold">'.$lang['addnew'].'</span>', array('?mod=categories' => '<i class="fa fa-folder-open btn-position"></i>'.$lang['categories_title'].'', ''.$lang['addnew'].'' ) );

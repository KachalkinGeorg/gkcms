        ...
        switch ($handlerName) {
            ...
            case 'by.category':
                ...
                if ($currentCategory['description']) {
					if ($callingParams['page']){
						$cat_page = "". $callingParams['page']." - страница. ". $currentCategory['name']. " - ". $currentCategory['description']. "";
					} else {
						$cat_page = "". $currentCategory['description']."";			
					}
                    $SYSTEM_FLAGS['meta']['description'] = $cat_page;
                }

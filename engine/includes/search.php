...
function search_news()
{
    ...
    if ($_REQUEST['nosearch'] == 0) {
        array_push($filter, ['DATA', 'nosearch', '=', $_REQUEST['nosearch']]);
    }
    ...
    $paginationParams = ['pluginName' => 'search', 'xparams' => ['search' => $_REQUEST['search'], 'author' => $_REQUEST['author'], 'catid' => $_REQUEST['catid'], 'nosearch' => $_REQUEST['nosearch'], 'postdate' => $_REQUEST['postdate']], 'paginator' => ['page', 1, false]];

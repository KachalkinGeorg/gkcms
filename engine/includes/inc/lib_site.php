...
{
    global $mysql, $lang, $userROW, $parse, $PFILTERS, $config, $catz, $catmap, $tvars, $twig, $PHP_SELF;
...
{
    global $lang, $parse, $mysql, $config, $PFILTERS, $userROW, $catmap, $tvars, $twig, $PHP_SELF;

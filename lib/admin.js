...
function ngNotifySticker(msg, o)
{
    var o = $.extend({                      // настройки по умолчанию
        time: 50000,                             // количество мс, которое отображается сообщение
    ...
    stickers.css('position', 'fixed').css({right: 'auto', left: 'auto', top: '50', bottom: 'auto', z-index: '20'}).css(o.position); // позиционируем
    var stick = $('<div class="ngStickerClass"><div class="modal-close" onclick="this.parentNode.style.display=\'none\';"><i class="fa fa-times-circle fa-2x"></i></div></div>'); // создаём стикер
